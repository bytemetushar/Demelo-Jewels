...
import { ShoppingBag, Eye, ChevronLeft, ChevronRight, Gem, Heart } from "lucide-react";
                ...
                >
                  ...
                  >
                    ...
                    <div className="relative aspect-[3/4] overflow-hidden">
                      ...
                      {badge && (
                        <span
                          className="absolute left-3 top-3 rounded-full px-3 py-1 font-['Jost'] text-[10px] font-semibold uppercase tracking-[0.15em]"
                          style={{
                      ...
                      <motion.button
                        ...
                        whileHover={{ backgroundColor: "rgba(180,145,90,0.9)" }}
                      >
                      ...
                      <motion.button
                        ...
                        className="absolute top-3 left-3 w-9 h-9 rounded-full flex items-center justify-center z-20 transition-all duration-300"
                        style={{
                      ...
                      <div className="absolute inset-x-0 bottom-0 p-3">
                        <motion.button
                          ...
                          className="w-full flex items-center justify-center gap-2 rounded-xl px-4 py-2.5 font-['Jost'] text-xs font-semibold transition-all duration-300 opacity-0 group-hover:opacity-100 translate-y-4 group-hover:translate-y-0"
                          style={{
                    ...
                    <div className="p-4 relative">
                      ...
                      />
                      <p className="mb-1.5 font-['Jost'] text-[10px] font-medium uppercase tracking-[0.2em]" style={{ color: "#b4915a" }}>
                        {category}
                      </p>
                      <h3 className="mb-2 font-['Marcellus'] text-base font-normal leading-snug" style={{ color: "#fff8ee" }}>
                        {name}
                      </h3>
