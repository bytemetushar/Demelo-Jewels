...
const brandLinks = [
  ...
  { label: "Craftsmanship", path: "/our-story" },
  { label: "Sustainability", path: "/our-story" },
  { label: "Press", path: "/our-story" },
];

const exploreLinks = [
  { label: "Collections", path: "/collections" },
  { label: "New Arrivals", path: "/new-arrivals" },
  { label: "Bespoke", path: "/collections" },
  { label: "Gift Guide", path: "/collections" },
];
      ...
      >
            ...
            <div className="mt-6 flex items-center gap-3">
              {["instagram", "pinterest", "email"].map((name) => (
                <a
                  ...
                  href="#"
                  aria-label={name}
                  className="inline-flex h-10 w-10 items-center justify-center rounded-full border transition-colors duration-200 hover:border-[#b4915a] hover:text-[#b4915a]"
                  ...
                  {links.map((l) => (
                    <li key={l.label}>
                      {l.path ? (
                        <Link
                          to={l.path}
                          className="text-[14px] font-normal transition-colors duration-200 hover:text-[#b4915a]"
        ...
        >
          <p className="text-[13px] font-normal" style={{ fontFamily: "'Jost', sans-serif", color: "rgba(255,248,238,0.35)" }}>
            &copy; {new Date().getFullYear()} Demelo Jewels. All rights reserved.
          </p>
          ...
          <div className="flex flex-wrap items-center gap-6">
            {legalLinks.map((l) => (
              <a
                key={l.label}
                href={l.href}
                className="text-[13px] font-normal transition-colors duration-200 hover:text-[rgba(255,248,238,0.6)]"
